...
from pulpcore.app.serializers import SecretCharField
...
class PulpAutoSchema(SwaggerAutoSchema):
    ...
    def get_default_response_serializer(self):
        ...
        for field_name, field in serializer.fields.items():
            is_secret = isinstance(field, SecretCharField)
            if not (field.write_only and not is_secret):  # Removing write_only fields
